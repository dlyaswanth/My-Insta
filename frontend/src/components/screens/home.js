                ...
                data.map(item=>
                    {
                        return(
                            <>&nbsp;
                                ...
                                &nbsp;&nbsp;
                                <input type="text" id="input" placeholder="Type comment" className="in" style={{border:"rigid",width:"60%"}} onChange={eve=>{setComment(eve.target.value)}} onSubmit={eve=>eve.target.value=""} autocomplete="off"/>
